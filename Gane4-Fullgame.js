...
var winLevel = function(){
    ...
    text("You passed the level!",200,100);
    textSize(14);
    stroke(29, 74, 7);
    fill(227, 254, 255);
    rectMode(CORNER);
...
var finalWin = function(){
    ...
    textAlign(CENTER,CENTER);
    textSize(22);
    text("YOU ARE THE ULTIMATE BEAVER!!!",200,100);
    beaver.x = mouseX;
    beaver.y = mouseY;
    flag.x = -100;
...
var loseLevel = function(){
    fill(56, 3, 3);
    textAlign(CENTER,CENTER);
    text("You failed the level",200,100);
    textSize(14);
    stroke(29, 74, 7);
    fill(227, 254, 255);
    rectMode(CORNER);
...
var startScreen = function(){
    ...
    fill(43, 9, 153);
    textSize(25);
    text("HOPPER's ADVENTURES!",200,70);
    ...
    textSize(9);
    text("Use SPACE to make Hopper jump\n\nGather as many sticks as possible (Score +1)\n\nAvoid red sticks! (Score -1)\n\nGetting stuck behind a wall = Game over\n\nFlag = Finish",20,220);
